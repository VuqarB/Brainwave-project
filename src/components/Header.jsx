...
const Header = () => {
    ...
    return (
        <header className={`fixed top-0 l-0 z-50 w-full border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${openNavigation ? 'bg-n-8' : 'bg-n-8/90 backdrop-blur-sm'}`}>
            <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
                ...
                <Button className='ml-auto lg:hidden' px='px-3' onClick={handleToggle}>
